...
size_t poseIndex = 0;
const MazeCellPose poseSequence[poseSequenceLength] = {{0, 0, 0},{236, 0, 0},{472,0,0},{472,0,M_PI/2},{472,236,M_PI/2},{472,236,M_PI},{236,236,M_PI},{0,236,M_PI},{0,236,1.5*M_PI},{0,0,1.5*M_PI},{0,0,2*M_PI} };
// Set up PID
