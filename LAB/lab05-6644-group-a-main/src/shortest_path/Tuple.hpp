...
struct Tuple<i, Arg, Args...> : public Node<i, Arg>, public Tuple<i + 1, Args...> {
    Tuple() = default;
    Tuple(Arg const& arg, Args const&... args)
        : Node<i, Arg>(arg), Tuple<i + 1, Args...>(args...) {}
};
...
bool operator==(mtrn3100::_tuple::Tuple<i, Arg> const& lhs,
                mtrn3100::_tuple::Tuple<i, Arg> const& rhs) {
...
bool operator==(mtrn3100::_tuple::Tuple<i, Arg1, Arg2, Args...> const& lhs,
    ...
    return mtrn3100::get<i>(lhs) == mtrn3100::get<i>(rhs) &&
           operator==(mtrn3100::_tuple::Tuple<i + 1, Arg2, Args...>(lhs),
