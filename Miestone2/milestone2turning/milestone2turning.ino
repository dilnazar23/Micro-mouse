...
// Set up PID
mtrn3100::PIDController pid(30, 0.1, 0.2, 0);
...
constexpr size_t poseSequenceLength = 6;
size_t poseIndex = 0;
const MazeCellPose poseSequence[poseSequenceLength] = {{0, 0, 0}, {0, 0, M_PI/2}, {0,0,M_PI}, {0,0,1.5*M_PI}, {0,0,2*M_PI}, {0,0,2.5*M_PI}};                                                      
